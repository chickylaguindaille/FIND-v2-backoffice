...
/**
 * @extends ServiceEntityRepository<Chicken>
 *
 ...
 */
class ChickenRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Chicken $entity, bool $flush = false): void
    {
    ...
    public function remove(Chicken $entity, bool $flush = false): void
    {
